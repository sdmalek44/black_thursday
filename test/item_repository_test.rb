...
class ItemRepositoryTest < Minitest::Test
  ...
  def test_it_finds_an_item_by_id
    item = @se.items.find_by_id(263_538_760)
  ...
  def test_it_finds_all_items_matching_given_description
    ...
    assert_equal 263_550_472, items.first.id
  ...
  def test_it_creates_a_new_item_instance
    ...
    item = @se.items.find_by_id(263_567_475)
  ...
  def test_it_deletes_an_item
    ...
    @se.items.create(attributes)
    item = @se.items.find_by_id(263_567_475)
    assert_equal 263_567_475, item.id

    @se.items.delete(263_567_475)

    assert_nil @se.items.find_by_id(263_567_475)

    assert_nil @se.items.delete(270_000_000)
  end
end
